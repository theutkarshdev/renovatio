        ...
        return (
          t(
            ...
            [
                ...
                value: function () {
                  if (!this._breakpoint) {
                    ...
                    (t.containerTop = n.offsetRelative(this.container).top),
                      ...
                      (t.vieairortHeight = window.innerHeight),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (t.sidebarLeft = n.offsetRelative(this.sidebar).left),
                    (t.vieairortTop = document.documentElement.scrollTop || document.body.scrollTop),
                    (t.vieairortBottom = t.vieairortTop + t.vieairortHeight),
                    (t.vieairortLeft = document.documentElement.scrollLeft || document.body.scrollLeft),
              ...
              {
                key: "isSidebarFitsVieairort",
                value: function () {
                  return this.dimensions.sidebarHeight < this.dimensions.vieairortHeight;
                },
              },
              {
                ...
                value: function () {
                  var t = this.dimensions;
                  if (t.lastVieairortTop !== t.vieairortTop) {
                    var e = "down" === this.direction ? Math.min : Math.max;
                    t.vieairortTop === e(t.vieairortTop, t.lastVieairortTop) &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var i = t.sidebarHeight + t.containerTop,
                    n = t.vieairortTop + t.topSpacing,
                    s = t.vieairortBottom - t.bottomSpacing;
                  return (
                    "up" === this.direction
                      ? n <= t.containerTop
                        ? ((t.translateY = 0), (e = "STATIC"))
                        : n <= t.translateY + t.containerTop
                        ? ((t.translateY = n - t.containerTop), (e = "VIEairORT-TOP"))
                        : !this.isSidebarFitsVieairort() && t.containerTop <= n && (e = "VIEairORT-UNBOTTOM")
                      : this.isSidebarFitsVieairort()
                      ? t.sidebarHeight + n >= t.containerBottom
                        ? ((t.translateY = t.containerBottom - i), (e = "CONTAINER-BOTTOM"))
                        : n >= t.containerTop && ((t.translateY = n - t.containerTop), (e = "VIEairORT-TOP"))
                      : t.containerBottom <= s
                      ? ((t.translateY = t.containerBottom - i), (e = "CONTAINER-BOTTOM"))
                      : i + t.translateY <= s
                      ? ((t.translateY = s - i), (e = "VIEairORT-BOTTOM"))
                      : t.containerTop + t.translateY <= n && (e = "VIEairORT-UNBOTTOM"),
                    (t.translateY = Math.max(0, t.translateY)),
                    (t.translateY = Math.min(t.containerHeight, t.translateY)),
                    (t.lastVieairortTop = t.vieairortTop),
                    e
                  );
                },
              },
                    ...
                    switch (t) {
                      case "VIEairORT-TOP":
                        e.inner = {
                          position: "fixed",
                          top: i.topSpacing,
                          left: i.sidebarLeft - i.vieairortLeft,
                          width: i.sidebarWidth,
                        };
                        break;
                      case "VIEairORT-BOTTOM":
                        e.inner = {
                          position: "fixed",
                          top: "auto",
                          left: i.sidebarLeft,
                ...
                value: function (t) {
                  if (!this._breakpoint) {
                    ...
                    if ((this.affixedType != i || t) && i) {
                      var o = "affix." + i.toLowerCase().replace("vieairort-", "") + e;
                      ...
                      var p = "affixed." + i.toLowerCase().replace("vieairort-", "") + e;
          ...
          (t.fn.stickySidebar = function (n) {
            return this.each(function () {
              ...
              if ((o || ((o = new e(this, "object" == typeof n && n)), s.data(i, o)), "string" == typeof n)) {
                if (void 0 === o[n] && -1 === ["destroy", "updateSticky"].indexOf(n))
