...
!(function (a, b, c, d) {
  ...
  function e(b, c) {
    ...
    a.each(a(this.element).data(), function (a, b) {
      ...
      (this.settings.vieairortFill = Math.max(Math.min(parseFloat(this.settings.vieairortFill), 1), 0)),
  ...
  ("undefined" == typeof console || "undefined" === console.warn) && ((console = {}), (console.warn = function () {})),
    a.isFunction(a.throttle) ||
      console.warn(
        "Fluidbox: The jQuery debounce/throttle plugin is not found/loaded. Even though Fluidbox works without it, the window resize event will fire extremely rapidly in browsers, resulting in significant degradation in performance upon vieairort resize.",
      );
  var k = function () {
      var a,
    ...
    m = {
      ...
      measure: {
        vieairort: function () {
          i.vieairort = { w: f.width(), h: f.height() };
        },
        fbElements: function () {
          var b = this,
            c = a(this.element),
          ...
          (b.instanceData.thumb = { natW: d[0].naturalWidth, natH: d[0].naturalHeight, w: d.width(), h: d.height() }),
            e.css({
              width: d.width(),
              height: d.height(),
              top: d.offset().top - f.offset().top + parseInt(d.css("borderTopWidth")) + parseInt(d.css("paddingTop")),
              left:
                d.offset().left - f.offset().left + parseInt(d.css("borderLeftWidth")) + parseInt(d.css("paddingLeft")),
            });
        },
      },
      checkURL: function (a) {
  ...
  a.extend(e.prototype, {
    ...
    open: function () {
      ...
      if ((f.append(g), c.removeClass("fluidbox--closed").addClass("fluidbox--loading"), m.checkURL(d.attr("src"))))
        return b.close(), !1;
    ...
    compute: function () {
      var b = this,
        ...
        m = h / j,
        n = i.vieairort.w / i.vieairort.h;
      b.settings.maxWidth > 0
        ? ((h = b.settings.maxWidth), (j = h / m))
        : b.settings.maxHeight > 0 && ((j = b.settings.maxHeight), (h = j * m));
      var o, p, q, r, s;
      n > m
        ? ((o = j < i.vieairort.h ? j : i.vieairort.h * b.settings.vieairortFill),
          (q = o / l),
          (r = (h * ((l * q) / j)) / k),
          (s = q))
        : ((p = h < i.vieairort.w ? h : i.vieairort.w * b.settings.vieairortFill),
          (r = p / k),
          (q = (j * ((k * r) / h)) / l),
          (s = r)),
        b.settings.maxWidth &&
      ...
      e.css({
        ...
        c
          ...
          .css({
            transform:
              "translate(" + parseInt(100 * u) / 100 + "px," + parseInt(100 * t) / 100 + "px) scale(" + v + ")",
          }),
    ...
    close: function (b) {
      ...
      return null === c.instanceData.state || typeof c.instanceData.state == typeof d || 0 === c.instanceData.state
        ? !1
        : ((c.instanceData.state = 0),
          ...
          g.css({
            ...
            left:
              f.offset().left - h.offset().left + parseInt(f.css("borderLeftWidth")) + parseInt(f.css("paddingLeft")),
          }),
    ...
    bindListeners: function () {
      var b = this,
        c = a(this.element),
        d = function () {
          m.measure.vieairort(), m.measure.fbElements.call(b), c.hasClass("fluidbox--opened") && b.compute();
        };
      a.isFunction(a.throttle)
