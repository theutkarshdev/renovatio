...
(function ($) {
  ...
  $(function () {
    ...
    $("form input[type=submit], form input[type=button], form button:not(.tutor-btn):not(.tutor-button)").addClass(
      "is-ready button is-primary " + $("html").data("generic-button-style"),
    );
    ...
    // FORMS
    $("input:not([type=submit]):not([type=button]):not([type=file]):not([type=radio]):not([type=checkbox])").addClass(
      "input-text",
    );
    ...
    if ($("html").hasClass("is-header-logo-center")) {
      ...
      $("<li></li>")
        .addClass("menu-logo")
        .insertAfter(".site-header .nav-menu > ul > li:nth-child(" + total + ")");
    ...
    $('.nav-menu a[href*="#"]').on("click", function () {
      if (window.matchMedia("(max-width: 992px)").matches) {
        //needs to work only on mobile menu
    ...
    if (post_thumbnail.length) {
      ...
      post_thumbnail.each(function () {
        ...
        if (postThumbnail.width() * window.devicePixelRatio * parallaxRatio > 1060) {
          // big screens
          src = postThumbnail.data("large-image");
        } else if (postThumbnail.width() * window.devicePixelRatio * parallaxRatio > 550) {
    ...
    $("#commentform, .post-password-form, .mc4air-form form, .mc4air-form").addClass("validate-form");
    $("#commentform")
      .find("input,textarea")
    ...
    if ($(".lightbox, .gallery, .portfolio-grid .hentry-middle, .portfolio-grid .featured-image").length) {
      $(".lightbox, .gallery,  .portfolio-grid .hentry-middle, .portfolio-grid .featured-image").each(function (
        index,
        element,
      ) {
        var $media_box = $(this);
    ...
    if ($("html.is-audio-embeds-sticky body.single-post").length) {
      $(
        'iframe[src*="spotify.com"],iframe[src*="podbean.com"],iframe[src*="soundcloud.com"],iframe[src*="simplecast.com"],iframe[src*="tunein.com"],iframe[src*="anchor.fm"],iframe[src*="radiopublic.com"],iframe[src*="castbox.fm"],iframe[src*="iheart.com"],iframe[src*="libsyn.com"],iframe[src*="deezer.com"],iframe[src*="mixcloud.com"],iframe[src*="buzzsprout.com"],iframe[src*="spreaker.com"],iframe[src*="cadence13.com"],iframe[src*="ausha.co"],iframe[src*="podomatic.com"],iframe[src*="blogtalkradio.com"],iframe[src*="megaphone.fm"],iframe[src*="transistor.fm"], iframe[src*="captivate.fm"]',
      ).addClass("sticky-audio");
  ...
  window.onload = function () {
    ...
    // ------------------------------
    // NOT FINAL *
    // should be compatible with elements which height is longer than vieairort
  ...
  function fixHeader() {
    ...
    if ($("html").hasClass("is-header-float")) {
      ...
      $(".top-content, .site-header + .site-main, .top-content-single, .site-header ~ .elementor").css(
        "marginTop",
        "-" + ++headerHeight + "px",
      );
    }
    ...
    if (isHeaderVertical) {
      ...
      $(".nav-menu li.has-submenu").each(function () {
        $(this)
          .find("ul")
          .css("padding-top", $(this).offset().top - $(window).scrollTop() + "px");
      });
  ...
  function fixFsRatio() {
    if (!$("html").hasClass("is-header-float")) {
      var headerHeight =
        parseInt($(".site-header:not(.clone").outerHeight()) + parseInt($(".site-header:not(.clone)").css("marginTop"));

      /* menu top logo overflow fix */
      headerHeight = $("html").is(".is-menu-top.is-logo-overflow")
        ? headerHeight - parseInt($(".site-header:not(.clone) .site-branding").outerHeight()) / 2
        : headerHeight;
  ...
  function setupFluidbox() {
    $(".entry-content > p a, .air-caption a, a.zoom").each(function () {
