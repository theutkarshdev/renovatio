        ...
        return (
          ...
          (t = [
            ...
            },
            {
              key: "isVisible",
              value: function () {
                return this.isElementInVieairort || !1;
              },
            },
            {
              key: "onScroll",
              value: function (e) {
                var t,
                  ...
                  g = {},
                  y = p;
                d.options.elementInVieairort && (y = d.options.elementInVieairort.getBoundingClientRect()),
                  (d.isElementInVieairort =
                    0 <= y.bottom && 0 <= y.right && y.top <= h && y.left <= b.window.innerWidth),
                  (e || d.isElementInVieairort) &&
                    ((t = Math.max(0, m)),
                    (n = Math.max(0, f + m)),
                    (o = Math.max(0, -m)),
                    (i = Math.max(0, m + f - h)),
