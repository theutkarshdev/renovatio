          ...
          (t = [
            ...
            },
            {
              ...
              value: function (e) {
                var t,
                  ...
                  r =
                    !(
                      !(t = e.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) ||
                      11 !== t[1].length
                    ) && t[1],
                  l =
                    !(
            ...
            },
            {
              ...
              value: function (e) {
                ...
                o.player &&
                  t &&
                  ("youtube" === o.type && o.player.setVolume && o.player.setVolume(t),
                ...
                a.videoImage
                  ...
                  : ("youtube" === a.type &&
                      ...
                      ((i = new Image()).onload = function () {
                        120 !== (this.naturalWidth || this.width) || o === e.length - 1
                          ? ((a.videoImage = "https://img.youtube.com/vi/".concat(a.videoID, "/").concat(e[o], ".jpg")),
                            t(a.videoImage))
                          : ((o += 1),
                    ...
                    "vimeo" === a.type &&
                      ((n = new XMLHttpRequest()).open(
                        "GET",
                        "https://vimeo.com/api/v2/video/".concat(a.videoID, ".json"),
                        !0,
                      ),
                      (n.onreadystatechange = function () {
                        ...
                        4 === this.readyState &&
                          200 <= this.status &&
                          this.status < 400 &&
                          ((e = JSON.parse(this.responseText)), (a.videoImage = e[0].thumbnail_large), t(a.videoImage));
                      }),
                      n.send(),
                      (n = null)));
              },
                      ...
                      u.$video || ((e = document.createElement("div")).style.display = "none"),
                        "youtube" === u.type &&
                          ...
                          (u.playerOptions.events = {
                            onReady: function (t) {
                              u.options.mute
                                ? t.target.mute()
                                : u.options.volume && t.target.setVolume(u.options.volume),
                            ...
                            onStateChange: function (e) {
                              u.options.loop && e.data === s.a.YT.PlayerState.ENDED && u.play(u.options.startTime),
                                t || e.data !== s.a.YT.PlayerState.PLAYING || ((t = 1), u.fire("started", e)),
                                ...
                                e.data === s.a.YT.PlayerState.PLAYING
                                  ? (o = setInterval(function () {
                                      u.fire("timeupdate", e),
                                        u.options.endTime &&
                                          u.player.getCurrentTime() >= u.options.endTime &&
                                          (u.options.loop ? u.play(u.options.startTime) : u.pause());
                                    }, 150))
                                  : clearInterval(o);
                            },
                            onError: function (e) {
                          ...
                          (i = !u.$video) &&
                            ((n = document.createElement("div")).setAttribute("id", u.playerID),
                            e.appendChild(n),
                        ...
                        "vimeo" === u.type &&
                          ...
                          u.$video ||
                            ...
                            u.$video.setAttribute(
                              "src",
                              "https://player.vimeo.com/video/".concat(u.videoID, "?").concat(a),
                            ),
                        ...
                        "local" === u.type &&
                          (u.$video ||
                            ...
                            u.options.mute
                              ? (u.$video.muted = !0)
                              : u.$video.volume && (u.$video.volume = u.options.volume / 100),
              ...
              value: function () {
                if (!p || !u) {
                  var e,
                    ...
                    o = "";
                  if (
                    ("youtube" !== this.type || p || ((p = 1), (o = "https://www.youtube.com/iframe_api")),
                    "vimeo" === this.type && !u)
                  ) {
  ...
  function (e, t, o) {
    ...
    function n() {
      var e,
        ...
        n,
        i,
        a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : p.a.jarallax;
      void 0 !== a &&
        ((e = a.constructor),
        ...
        (e.prototype.onScroll = function () {
          ...
          t.apply(o),
            o.isVideoInserted ||
              !o.video ||
              (o.options.videoLazyLoading && !o.isElementInVieairort) ||
        ...
        (e.prototype.coverImage = function () {
          ...
          return (
            a &&
              ...
              (i = a.image.marginTop),
              a.container.width > t &&
                ((e = ((t = a.container.width) * n.image.height) / n.image.width),
                (o = 0),
          ...
          if (t.isValid())
            if (
              (this.options.disableParallax() &&
                ((e = !0), (o.image.position = "absolute"), (o.options.type = "scroll"), (o.options.speed = 1)),
              e)
            ) {
              if (
                (t.on("ready", function () {
                  ...
                  o.options.videoPlayOnlyVisible
                    ? ((e = o.onScroll),
                      (o.onScroll = function () {
                        e.apply(o),
                          o.videoError ||
                            (!o.options.videoLoop && (o.options.videoLoop || o.videoEnded)) ||
