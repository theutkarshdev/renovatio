...
!(function (e, t) {
    ...
    parent: function (e) {
      for (var t = [], i = 0; i < this.length; i += 1)
        null !== this[i].parentNode &&
          (e ? n(this[i].parentNode).is(e) && t.push(this[i].parentNode) : t.push(this[i].parentNode));
      return n(o(t));
    },
    parents: function (e) {
      for (var t = [], i = 0; i < this.length; i += 1)
  ...
  var b = {
    setGrabCursor: function (e) {
      if (
        !(h.touch || !this.params.simulateTouch || (this.params.watchOverflow && this.isLocked) || this.params.cssMode)
      ) {
        var t = this.el;
        (t.style.cursor = "move"),
    ...
    if (!this.animating || !s.preventInteractionOnTransition) {
      ...
      if (
        ...
        (t.isTouchEvent || !("which" in o) || 3 !== o.which) &&
          !((!t.isTouchEvent && "button" in o && o.button > 0) || (t.isTouched && t.isMoved)))
      )
      ...
      if (!t.isTouchEvent || "touchmove" === o.type) {
        ...
        if (!this.allowTouchMove)
          return (
            ...
            void (
              t.isTouched &&
              (d.extend(a, { startX: h, startY: p, currentX: h, currentY: p }), (t.touchStartTime = d.now()))
            )
          );
              ...
              if (
                ...
                f > 0 && t.currentTranslate > this.minTranslate()
                  ? ((m = !1),
                    s.resistance &&
                      (t.currentTranslate =
                        this.minTranslate() - 1 + Math.pow(-this.minTranslate() + t.startTranslate + f, g)))
                  : f < 0 &&
                    t.currentTranslate < this.maxTranslate() &&
                    ((m = !1),
                    s.resistance &&
                      (t.currentTranslate =
                        this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - t.startTranslate - f, g))),
  ...
  var W = {
        ...
        if ((s = c[0])) {
          ...
          return (
            ...
            d.extend(l, {
              ...
              rtlTranslate:
                "horizontal" === l.params.direction && ("rtl" === s.dir.toLowerCase() || "rtl" === c.css("direction")),
    ...
    se = {
      handle: function (e) {
        ...
        if (
          ...
          if (this.params.keyboard.onlyInVieairort && (o || l || d || h || p || c)) {
            var u = !1;
            if (
    ...
    ae = {
      name: "keyboard",
      params: { keyboard: { enabled: !1, onlyInVieairort: !0, pageUpDown: !0 } },
      create: function () {
        d.extend(this, {
          keyboard: {
            enabled: !1,
  ...
  var re = {
      ...
      handle: function (e) {
        ...
        if ((s.invert && (r = -r), i.params.freeMode)) {
          ...
          if (
            (x.push(y),
            E
              ? (y.direction !== E.direction || y.delta > E.delta || y.time > E.time + 150) &&
                        ...
                        : (h && (o.attr("srcset", h), o.removeAttr("data-srcset")),
                          ...
                          c.length &&
                            c.children("source").each(function (e, t) {
                              var i = n(t);
                              i.attr("data-srcset") &&
                                (i.attr("srcset", i.attr("data-srcset")), i.removeAttr("data-srcset"));
                            }),
      ...
      setTranslate: function () {
        ...
        for (var u = 0; u < s.length; u += 1) {
          ...
          if (
            ...
            0 === T.length &&
              ((T = n('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>')), v.append(T)),
              0 === S.length &&
                ((S = n('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>')), v.append(S)),
      ...
      setTranslate: function () {
        for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
          ...
          if (
            ...
            0 === h.length &&
              ((h = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>')),
              s.append(h)),
              0 === p.length &&
                ((p = n('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>')),
                s.append(p)),
      ...
      setTranslate: function () {
        for (
          ...
          if ((f.transform(C), (f[0].style.zIndex = 1 - Math.abs(Math.round(g))), r.slideShadows)) {
            ...
            0 === M.length &&
              ((M = n('<div class="swiper-slide-shadow-' + (o ? "left" : "top") + '"></div>')), f.append(M)),
              0 === P.length &&
                ((P = n('<div class="swiper-slide-shadow-' + (o ? "right" : "bottom") + '"></div>')), f.append(P)),
        ...
        e.swiper instanceof t
          ...
          : d.isObject(e.swiper) &&
            ((this.thumbs.swiper = new t(
              d.extend({}, e.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }),
            )),
      ...
      onThumbClick: function () {
        ...
        if (e) {
          ...
          if (!((i && n(i).hasClass(this.params.thumbs.slideThumbActiveClass)) || null == t)) {
            var s;
            if (
              ((s = e.params.loop ? parseInt(n(e.clickedSlide).attr("data-swiper-slide-index"), 10) : t),
              this.params.loop)
            ) {
              var a = this.activeIndex;
    ...
    Ee = [
      ...
      },
      {
        ...
        create: function () {
          d.extend(this, {
            lazy: { initialImageLoaded: !1, load: pe.load.bind(this), loadInSlide: pe.loadInSlide.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          d.extend(this, {
            fadeEffect: { setTranslate: ge.setTranslate.bind(this), setTransition: ge.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          d.extend(this, {
            cubeEffect: { setTranslate: be.setTranslate.bind(this), setTransition: be.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          d.extend(this, {
            flipEffect: { setTranslate: we.setTranslate.bind(this), setTransition: we.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          d.extend(this, {
            coverflowEffect: { setTranslate: ye.setTranslate.bind(this), setTransition: ye.setTransition.bind(this) },
          });
        },
        on: {
          beforeInit: function () {
