!(function (d) {
  ...
  var x = {
        ...
        elementorFrontend.config.experimentalFeatures.e_optimized_assets_loading
          ? (o = setInterval(function () {
              "undefined" !== elementorFrontend.utils.swiper &&
                (new elementorFrontend.utils.swiper(e[0], Object.assign(t, n)).then((e) => {}), clearInterval(o));
            }, 200))
        ...
        var o = void 0 !== e.data("options") ? e.data("options") : {},
          ...
          I =
            void 0 !== o.slidesPerView480 && "" !== o.slidesPerView480
              ...
              : 1 + n;
        if (
          (m || (s < 2 ? (y = C = b = q = s) : s < 3 ? (C = b = q = s) : s < 4 ? (b = q = s) : s < 5 && (q = s)),
          "never" !== i)
        )
          switch (i) {
            case 1024:
                ...
                i.sliderScroll &&
                  ...
                  n.off().on("wheel", function (e) {
                    e.preventDefault(),
                      o ||
                        ((o = !0),
                        0 < e.originalEvent.deltaY ? n[0].swiper.slideNext() : n[0].swiper.slidePrev(),
                        setTimeout(function () {
                          o = !1;
                        }, 1e3));
                  })),
            ...
            refreshFsLightbox(),
              "undefined" != typeof qodefGlobal &&
                ((qodefQiAddonsGlobal.vars.iconArrowLeft = (
                  void 0 !== qodefGlobal.vars.iconArrowLeft ? qodefGlobal : qodefQiAddonsGlobal
                ).vars.iconArrowLeft),
                (qodefQiAddonsGlobal.vars.iconArrowRight = (
                  void 0 !== qodefGlobal.vars.iconArrowRight ? qodefGlobal : qodefQiAddonsGlobal
                ).vars.iconArrowRight),
                (qodefQiAddonsGlobal.vars.iconClose = (
                  void 0 !== qodefGlobal.vars.iconClose ? qodefGlobal : qodefQiAddonsGlobal
                ).vars.iconClose));
          ...
          (this.holder = d(".qodef-qi--has-appear:not(.qodef-qi--appeared)")),
            this.holder.length &&
              this.holder.each(function () {
                ...
                n
                  ? ((n = "random" === n ? t : n),
                    qodefAddonsCore.qodefIsInVieairort.check(o, function () {
                      setTimeout(function () {
    ...
    t =
      ((qodefAddonsCore.qodefAppear = o),
      {
        check: function (o, t, n) {
          var e, i;
          o.length &&
            ((e = void 0 !== o.data("vieairort-offset") ? o.data("vieairort-offset") : 0.15),
    ...
    t =
      ((qodefAddonsCore.qodefIsInVieairort = t),
      {
        check: function (e, o) {
          if (e.length) {
            var t = e.find("img");
    ...
    n =
      ...
      {
        disable: function () {
          window.addEventListener && window.addEventListener("wheel", n.preventDefaultValue, { passive: !1 }),
            (document.onkeydown = n.keyDown);
        },
        enable: function () {
          window.removeEventListener && window.removeEventListener("wheel", n.preventDefaultValue, { passive: !1 }),
            ...
            this.holder.each(function () {
              ...
              o.css("width", t),
                "function" == typeof e.isotope &&
                  ...
                  (i(this).hasClass("qodef-items--fixed") && d.setFixedImageProportionSize(e, o, t, n),
                  e.isotope({
                    layoutMode: "packery",
        ...
        t.css("width", n),
          qodefAddonsCore.qodefWaitForImages.check(o, function () {
            "function" != typeof o.isotope ||
              ...
              (e.hasClass("qodef-items--fixed") && d.setFixedImageProportionSize(o, t, n, i),
              o.isotope({
                layoutMode: "packery",
                itemSelector: ".qodef-grid-item",
                percentPosition: !0,
      ...
      setFixedImageProportionSize: function (e, o, t, n) {
        ...
        e.parent().hasClass("qodef-col-num--1")
          ...
          : (o.css({ height: t }),
            ...
            a.length && a.css({ height: Math.round(2 * t + n), width: Math.round(2 * t + n) }),
            s &&
              (d.length && d.css({ height: Math.round(t / 2), width: Math.round(t) }), a.length) &&
    ...
    var o = {
      ...
      initAccordion: function (e) {
        ...
        e.hasClass("qodef-height--content") && (o = "content"),
          e.accordion({ animate: "swing", collapsible: !0, active: 0, icons: "", heightStyle: o });
      },
    ...
    var o = {
      ...
      initItem: function (e) {
        ...
        e.hasClass("qodef-type--icon-boxed") &&
          ((o = e.find(".qodef-m-icon")), (e = e.find(".qodef-m-text").outerHeight()), o.css("width", e));
      },
    };
      ...
      initItem: function (e) {
        e.each(function () {
          ...
          o.hasClass("qodef-type--icon-boxed") &&
            ((e = o.find(".qodef-m-icon")), (o = o.find(".qodef-m-text").outerHeight()), e.css("width", o));
        });
      },
    };
      ...
      sliderLoop: function (t, e) {
        ...
        function a() {
          ...
          e.hasClass("qodef-out") ||
            e.addClass("qodef-out").animate({ right: n }, 350, "swing", function () {
              e
                .detach()
                .insertBefore(o)
        ...
        setInterval(function () {
          ...
          r.on("click", function () {
            ...
            o.hasClass("qodef-in") ||
              ...
              o.addClass("qodef-in").animate({ right: n }, 350, "swing", function () {
                o
                  .detach()
                  .insertAfter(e)
                  .animate({ right: "0" }, 450, "swing", function () {
      ...
      initItem: function (t) {
        ...
        r(i.get().reverse()).each(function (e) {
          ...
          o.on("click", function () {
            if (!i.last().is(o))
              return (
                "both" === d && (n = o.index() % 2 ? "0 0 0 20%" : "0 0 0 -20%"),
                o.addClass("qodef-out").animate({ margin: n }, 200, "swing", function () {
                  o.detach(),
                    o.insertAfter(i.last()).animate({ margin: "0" }, 200, "swing", function () {
  ...
  (function (e) {
    ...
    var o = {
      ...
      initItem: function (e) {
        qodefAddonsCore.qodefIsInVieairort.check(e, function () {
          ...
          I = {
            ...
            options: {
              ...
              plugins: {
                ...
                tooltip: { titleFont: { size: 13 }, displayColors: !1, cornerRadius: 5, caretSize: 6 },
              },
            },
          };
      ...
      initCountdown: function (c, h) {
        var u = new Date(h.date).getTime(),
          q = setInterval(function () {
            ...
            r.find(".qodef-label").html(1 === o ? h.monthLabel : h.monthLabelPlural),
              a.find(".qodef-label").html(1 === t ? h.dayLabel : h.dayLabelPlural),
              s.find(".qodef-label").html(1 === n ? h.hourLabel : h.hourLabelPlural),
              l.find(".qodef-label").html(1 === i ? h.minuteLabel : h.minuteLabelPlural),
              f.find(".qodef-label").html(1 === d ? h.secondLabel : h.secondLabelPlural),
              (o = o < 10 ? "0" + o : o),
              (t = t < 10 ? "0" + t : t),
              (n = n < 10 ? "0" + n : n),
              (i = i < 10 ? "0" + i : i),
  ...
  (function (e) {
    ...
    var o = {
      ...
      initItem: function (e) {
        ...
        o.parents(".qodef-qi-before-after").hasClass("qodef--vertical") && (n = "vertical"),
          qodefAddonsCore.qodefWaitForImages.check(o, function () {
  ...
  (function (e) {
    ...
    var n = {
      ...
      initItem: function (t) {
        qodefAddonsCore.qodefIsInVieairort.check(t, function () {
            ...
            options: {
              ...
              plugins: {
                legend: {
                  ...
                  position: g,
                  align: v,
                  labels: { boxWidth: w, boxHeight: b, padding: C, color: y, font: { family: A, size: I, weight: e } },
                },
                tooltip: {
                  mode: "nearest",
                  intersect: !1,
              ...
              scales: {
                x: {
                  ...
                  ticks: { color: "#c4c4c4", font: { family: '"DM Sans"', size: 16 }, padding: 10 },
                ...
                y: {
                  ...
                  suggestedMax: n.max,
                  suggestedMin: n.min,
                  ticks: { stepSize: n.step, color: "#c4c4c4", font: { family: '"DM Sans"', size: 16 }, padding: 10 },
    ...
    var o = {
      ...
      initItem: function (e) {
        ...
        e.hasClass("qodef-behavior--accordion") &&
          ...
          e.accordion({ animate: "swing", collapsible: !0, active: o, icons: "", heightStyle: "content" }),
          e.addClass("qodef--init"));
      },
    };
    ...
    var n = {
      ...
      generateOptions: function (e) {
        ...
        return (
          ...
          (o.delay =
            void 0 !== e.data("step-delay") && "" !== e.data("step-delay") ? parseInt(e.data("step-delay"), 10) : 100),
          (o.txt =
            void 0 !== e.data("digit-label") && "" !== e.data("digit-label") ? String(e.data("digit-label")) : ""),
          o
        );
      },
      counterScript: function (e, o) {
        var t = r.extend({ start: 0, end: null, step: 1, delay: 50, txt: "" }, o || {}),
          n = t.start,
          i = t.end,
          d =
            (e.text(n + t.txt),
  ...
  (function (e) {
    ...
    var o = {
      ...
      initItem: function (e) {
        var o;
        e.hasClass("qodef-type--icon-boxed") &&
          ((o = e.find(".qodef-m-icon")), (e = e.find(".qodef-m-text-holder").outerHeight()), o.css("width", e));
      },
    };
    ...
    var e = {
      ...
      initItem: function (e) {
        var o = setInterval(function () {
          e.children(".qodef-qi-swiper-container").hasClass("qodef-swiper--initialized") &&
            (e.find(".qodef-device-carousel-device .qodef-qi-swiper-container").each(function () {
              var e = t(this);
    ...
    var o = {
      ...
      parallaxElements: function (e) {
        var e = e.find(".qodef-m-images"),
          ...
          r = 15;
        1024 < qodefAddonsCore.windowWidth &&
          (void 0 !== e && !1 !== e && ((n = e), (d = Math.abs(parseInt(n / 0.9, 10)))),
          t.attr("data-parallax", '{"y" : ' + n + ' , "smoothness": ' + d + "}"),
          o.each(function () {
            var e = a(this),
              o = e.find("img"),
              e = e.attr("data-parallax");
            void 0 !== e && !1 !== e && ((i = e), (r = Math.abs(parseInt(i / 2.5, 10)))),
  ...
  (function (e) {
    ...
    var i = {
      ...
      initItem: function (n) {
        qodefAddonsCore.qodefIsInVieairort.check(n, function () {
          ...
          n
            .on("touchstart mouseenter", function (e) {
              ...
              (!qodefAddonsCore.body.hasClass("qodef-qi--touch") ||
                (!o.hasClass("qodef--active") && 680 < qodefAddonsCore.windowWidth)) &&
                (e.preventDefault(),
            ...
            .on("touchend mouseleave", function () {
              var e = i(this);
              (!qodefAddonsCore.body.hasClass("qodef-qi--touch") ||
                (!e.hasClass("qodef--active") && 680 < qodefAddonsCore.windowWidth)) &&
                (n.removeClass("qodef--active").eq(e.index()).addClass("qodef--active"),
          ...
          (e = u.prepareHeadings(n, i, o)).length &&
            (e.each(function (e) {
              var o,
                ...
                r = u.prepareId(c, d, l);
              (l += r.id + ";"),
                (f[e] = { id: r.finalID, tag: i.prop("tagName").replace("H", "") }),
                0 < e &&
                  ((o = i.prop("tagName").replace("H", "")),
                  (t = f[e - 1].tag) < o
                    ? ((n = s.find("a[href=#" + f[e - 1].id + "]").parent()).append("<" + a + ">"),
                      (s = n.find(a).first()))
                    : o < t &&
                      ...
                      (s = s
                        ...
                        .first()))),
                i.attr("id", r.finalID),
                s.append('<li><a href="#' + r.finalID + '">' + d.text() + "</a></li>");
            }),
  ...
  (function (e) {
    ...
    var o = {
      ...
      initSwiperReinit: function (e) {
        var o,
          t = e.find(".qodef-m-main-slider > .qodef-qi-swiper-container .swiper-slide-active"),
    ...
    (qodefAddonsCore.shortcodes.qi_addons_for_elementor_slider_switch.qodefSwiper = qodefAddonsCore.qodefSwiper),
      (qodefAddonsCore.shortcodes.qi_addons_for_elementor_slider_switch.qodefSliderSwitch = o);
  })(jQuery),
  (function (n) {
    "use strict";
    ...
    var a = {
        ...
        qodefAddonsCore.qodefIsInVieairort.check(n, function () {
          ...
          a.initVerticalBar(e, o, t, n),
            n.hasClass("qodef-percentage--floating-top") &&
              n.find(".qodef-m-inner").width(n.find(".qodef-m-canvas svg").width());
        });
      },
      generateBarData: function (t) {
        ...
        return {
          ...
          trailColor: d,
          trailWidth: (100 * i) / e,
          svgStyle: { display: "block", height: e + "px", transform: "scaleY(-1)" },
          easing: "linear",
          duration: r,
          from: { color: d },
          to: { color: n },
      ...
      initVerticalBar: function (e, o, t, n) {
        ...
        a.checkBar(e) &&
          ...
          (r = (d = n[0].querySelector(".qodef-m-canvas svg path:last-of-type")).getAttribute("stroke-width")),
  ...
  (function (d) {
    ...
    var n = {
            ...
            e.each(function () {
              ...
              e.on("click", function (e) {
                e.preventDefault(),
                  d.ajax({
                    type: "POST",
                    data: { action: "qi_addons_for_elementor_notice", notice_action: o, nonce: t.val() },
                    url: ajaxurl,
                    success: function (e) {
      ...
      r = {
        init: function () {
          (this.deactivationLink = d("#the-list").find('[data-slug="qi-addons-for-elementor"] span.deactivate a')),
            (this.deactivationModal = d("#qi-addons-for-elementor-deactivation-modal")),
            this.deactivationLink.length && this.deactivationModal.length && this.initModal();
        },
        initModal: function () {
        ...
        initSubmitFunctionality: function () {
          ...
          t.length &&
            t.on("click", function (e) {
              ...
              var o,
                e = r.deactivationModal.find('input[name="reason_key"]:checked').val();
              switch (e) {
              ...
              d.ajax({
                type: "POST",
                data: { action: "qi_addons_for_elementor_deactivation", reason: e, additionalInfo: o, nonce: i.val() },
                url: ajaxurl,
                success: function (e) {
                  d.parseJSON(e);
                  r.deactivatePlugin();
            ...
            if (o.length) {
              for (
                var t = o.siblings(".add_to_cart_button"),
                  n = ["button", "product_type_simple", "add_to_cart_button", "ajax_add_to_cart", "added"],
                  i = t.attr("class"),
