    ...
    reInitShortcode: function (key, keyChild) {
      elementorFrontend.hooks.addAction("frontend/element_ready/" + key + ".default", function (e) {
        ...
        if (typeof qodefAddonsCore.shortcodes[key][keyChild] === "undefined") {
          ...
          typeof qodefAddonsCore.shortcodes[key][keyChild].initSlider === "function" &&
          ...
          typeof qodefAddonsCore.shortcodes[key][keyChild].initItem === "function" &&
          ...
          qodeWidgetsPromoHandler = {
            ...
            onMouseDown: function () {
              ...
              elementor.promotion.showDialog({
                ...
                title: sprintf(air.i18n.__("%s Widget", "qi-addons-for-elementor"), title),
                content: content,
                position: {
                  blockStart: "-7",
                },
