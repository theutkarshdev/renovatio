...
if (isset($_POST['lead_name']) && isset($_POST['lead_email'])) {
    // Assuming your HTML form has fields named 'lead_name', 'lead_email', 'lead_phone', 'lead_location', 'lead_size', and 'lead_budget'
    $lead_name = sanitize_input($_POST['lead_name']);
    $lead_email = sanitize_input($_POST['lead_email']);
    $lead_phone = sanitize_input($_POST['lead_phone']);
    $lead_location = sanitize_input($_POST['lead_location']);
    $lead_size = sanitize_input($_POST['lead_size']);
    $lead_budget = sanitize_input($_POST['lead_budget']);
    ...
    try {
        ...
        // Recipient (user)
        $mail->addAddress($lead_email, $lead_name);
...
<body>
	<table border="0" cellpadding="0" cellspacing="0" class="m_4750760328253690921nl2go-body-table" role="presentation" style="background-color:#ffffff;width:100%" width="100%">
																										...
																										<tbody>
																											<tr>
																												<td align="left" class="m_4750760328253690921r13-i m_4750760328253690921nl2go-default-textstyle" style="color:#3b3f44;font-family:arial,helvetica,sans-serif;font-size:16px;line-height:1.5;word-break:break-word;padding-bottom:15px;padding-top:15px;text-align:left;word-wrap:break-word" valign="top">
																													<div>
																														<p style="margin:0"><span style="font-family:Palatino,"Palatino Linotype","Palatino LT STD","Book Antiqua",Georgia,serif">Hi&nbsp;'. $lead_name .'</span></p>
																														<p style="margin:0">&nbsp;</p>
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Sales lead generated';
