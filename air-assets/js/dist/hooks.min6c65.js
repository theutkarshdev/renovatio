...
!(function () {
  ...
  var e = function (n) {
    return "string" != typeof n || "" === n
      ...
      : !!/^[a-zA-Z][a-zA-Z0-9_.-]*$/.test(n) ||
        (console.error("The hook name can only contain numbers, letters, dashes, periods and underscores."), !1);
  };
  var o = function (n, t) {
  ...
  var u = function (n, t) {
    return function () {
      var r, e;
      const o = n[t];
      return null !== (r = null === (e = o.__current[o.__current.length - 1]) || void 0 === e ? void 0 : e.name) &&
        void 0 !== r
        ? r
        : null;
    };
