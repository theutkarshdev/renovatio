...
window.addComment = (function (v) {
  var I,
    ...
    b = {
      ...
      temporaryFormId: "air-temp-form-div",
  ...
  function l(e) {
    ...
    d &&
      ...
      d &&
        ...
        t &&
        (n && "A" === n.nodeName && n.id !== b.cancelReplyId && (n.style.display = ""), (d.textContent = t)),
      e.preventDefault());
  }
  function a(e) {
        ...
        if (e && h && n) {
          void 0 === o && (o = p && p.textContent),
            ...
            p &&
              ...
              (u && "A" === u.nodeName && u.id !== b.cancelReplyId && (u.style.display = "none"), (p.textContent = o)),
            (I.onclick = function () {
              return !1;
            });
          try {
