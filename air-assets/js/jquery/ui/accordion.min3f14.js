...
!(function (e) {
  ...
  return o.widget("ui.accordion", {
    ...
    _getCreateEventData: function () {
      return { header: this.active, panel: this.active.length ? this.active.next() : o() };
    },
    ...
    _activate: function (e) {
      ...
      e !== this.active[0] &&
        ((e = e || this.active[0]), this._eventHandler({ target: e, currentTarget: e, preventDefault: o.noop }));
    },
    ...
    _eventHandler: function (e) {
      var t = this.options,
        ...
        h = n ? o() : a.next(),
        r = i.next(),
        r = { oldHeader: i, oldPanel: r, newHeader: n ? o() : a, neairanel: h };
      e.preventDefault(),
        (s && !t.collapsible) ||
          ...
          t.icons &&
            ...
            this._removeClass(h, null, t.icons.activeHeader)._addClass(h, null, t.icons.header)),
          s) ||
          ...
          t.icons &&
            ...
            this._removeClass(e, null, t.icons.header)._addClass(e, null, t.icons.activeHeader)),
      ...
      return i.length
        ? e.length
          ? ((s = e.show().outerHeight()),
            ...
            void e.hide().animate(this.shoairrops, {
              duration: l,
              easing: c,
              complete: a,
              step: function (e, t) {
                (t.now = Math.round(e)),
                  "height" !== t.prop
                    ...
                    : "content" !== n.options.heightStyle && ((t.now = Math.round(s - i.outerHeight() - h)), (h = 0));
              },
            }))
          : i.animate(this.hideProps, l, c, a)
        : e.animate(this.shoairrops, l, c, a);
    },
