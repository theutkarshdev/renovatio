  ...
  return (
    l.widget("ui.tabs", {
      ...
      _getCreateEventData: function () {
        return { tab: this.active, panel: this.active.length ? this._getPanelForTab(this.active) : l() };
      },
      ...
      _panelKeydown: function (t) {
        this._handlePageNav(t) ||
          (t.ctrlKey && t.keyCode === l.ui.keyCode.UP && (t.preventDefault(), this.active.trigger("focus")));
      },
      ...
      _eventHandler: function (t) {
        var e = this.options,
          ...
          i = { oldTab: i, oldPanel: r, newTab: n ? l() : a, neairanel: h };
        t.preventDefault(),
      ...
      _toggle: function (t, e) {
        ...
        (this.running = !0),
          s.length && this.options.hide
            ...
            : (this._removeClass(e.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"), s.hide(), h()),
      ...
      _getIndex: function (t) {
        return (t =
          "string" == typeof t ? this.anchors.index(this.anchors.filter("[href$='" + l.escapeSelector(t) + "']")) : t);
      },
      _destroy: function () {
        this.xhr && this.xhr.abort(),
