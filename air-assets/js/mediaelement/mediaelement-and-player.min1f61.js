...
})(
  {
        ...
        var i = function e(t, n, o) {
          ...
          (f.mediaElement.id = i),
            ...
            (f.mediaElement.changeRenderer = function (e, t) {
              ...
              for (
                var a = n.mediaElement.options.renderers.length ? n.mediaElement.options.renderers : D.renderer.order,
                  s = 0,
                  l = a.length;
                s < l;
                s++
              ...
              if (o.isVideo)
                if (
                  ...
                  if (
                    ...
                    for (
                      var n = o.getElement(o.container).querySelectorAll("embed, object, video"), i = n.length, r = 0;
                      r < i;
                      r++
                    )
                  ...
                  u &&
                    ...
                    (o
                      ...
                      .querySelector("." + o.options.classPrefix + "captions-position").style.bottom =
            ...
            buildprogress: function (h, s, e, d) {
              ...
              g.slider.addEventListener("focus", function () {
                ...
                g.slider.addEventListener("keydown", function (e) {
                  if (
                    (1e3 <= new Date() - u && (c = g.paused), g.options.enableKeyboard && g.options.keyActions.length)
                  ) {
                    var t = e.which || e.keyCode || 0,
                      n = g.getDuration(),
              ...
              g.slider.addEventListener("mouseenter", function (e) {
                ...
                g.slider.addEventListener("mouseleave", function () {
                  g.getDuration() !== 1 / 0 &&
                    (v ||
                      (g.timefloat && (g.timefloat.style.display = "none"),
                      g.hovered && g.options.useSmoothHover && (0, b.addClass)(g.hovered, "no-hover")));
                }),
        ...
        Object.assign(o.config, {
            ...
            buildtracks: function (o, e, t, n) {
              if ((this.findTracks(), o.tracks.length || (o.trackFiles && 0 !== !o.trackFiles.length))) {
                ...
                i.cleartracks(o),
                  ...
                  (o.captionsButton.querySelector("." + i.options.classPrefix + "captions-selector-input").disabled =
                    !1),
                    ...
                    return (
                      ...
                      (e.captionsText.innerHTML = (function (e) {
                        ...
                        for (var i = t.getElementsByTagName("*"), r = 0, a = i.length; r < a; r++)
                          for (
                            var s = i[r].attributes, l = Array.prototype.slice.call(s), d = 0, u = l.length;
                            d < u;
                            d++
                          )
          ...
          (d.default.TrackFormatParser = {
            ...
            dfxp: {
              parse: function (e) {
                var t = L.default
                    .adoptNode(new DOMParser().parseFromString(e, "application/xml").documentElement)
                    .querySelector("div"),
                ...
                for (var d = 0, u = n.length; d < u; d++) {
                  ...
                  if (
                    ...
                    !f.start &&
                      ...
                      (f.start = (0, m.convertSMPTEtoSeconds)(n[d - 1].getAttribute("end"))),
                    n[d].getAttribute("end") && (f.stop = (0, m.convertSMPTEtoSeconds)(n[d].getAttribute("end"))),
                    !f.stop &&
                      n[d + 1].getAttribute("begin") &&
                      (f.stop = (0, m.convertSMPTEtoSeconds)(n[d + 1].getAttribute("begin"))),
                    r)
                  )
              ...
              if ((!P.IS_ANDROID && !P.IS_IOS) || !this.options.hideVolumeOnTouchDevices) {
                ...
                o.addEventListener("rendererready", function () {
                  ...
                  (0 === e.options.startVolume || o.originalNode.muted) &&
                    (o.setMuted(!0), 0 === e.options.startVolume && (e.options.startVolume = 0), b()),
    ...
    16: [
      function (e, t, n) {
        ...
        var s = (n.config = {
          poster: "",
          shoairosterWhenEnded: !1,
          shoairosterWhenPaused: !1,
            ...
            o(r, [
                  ...
                  if (
                    ...
                    if (
                      ...
                      n.options.features.length ||
                        ...
                        (n
                          ...
                          .querySelector("." + n.options.classPrefix + "controls").style.display = "none")),
                      n.isVideo &&
                    ...
                    w.IS_ANDROID && P.addClass(n.getElement(n.container), n.options.classPrefix + "android"),
                      ...
                      P.addClass(
                        ...
                        n.isVideo ? n.options.classPrefix + "video" : n.options.classPrefix + "audio",
                      ),
                      n
                        .getElement(n.container)
                ...
                value: function (e) {
                  ...
                  if (((e = void 0 === e || e), !i.controlsAreVisible && i.isVideo)) {
                    if (e)
                      ...
                      for (
                        var t = i.getElement(i.container).querySelectorAll("." + i.options.classPrefix + "control"),
                          n = 0,
                          o = t.length;
                        n < o;
                        n++
                ...
                value: function () {
                  ...
                  if (
                    ...
                    0 < o.getElement(o.container).parentNode.length &&
                      ...
                      ((l =
                        S.default.innerWidth || x.default.documentElement.clientWidth || x.default.body.clientWidth),
                      (s =
              ...
              },
              {
                ...
                value: function (e, t, n, o) {
                  ...
                  "" !== e.options.poster &&
                    (a && w.IS_IOS && o.originalNode.removeAttribute("poster"), (a = e.options.poster)),
                    a
                      ? i.setPoster(a)
                    ...
                    e.options.shoairosterWhenEnded &&
                    ...
                    e.options.shoairosterWhenPaused &&
                      o.addEventListener("pause", function () {
          ...
          detectPlugin: function (e, t, n, o) {
            ...
            if (null !== F.NAV.plugins && void 0 !== F.NAV.plugins && "object" === d(F.NAV.plugins[e])) {
              if (
                ...
                (void 0 === F.NAV.mimeTypes || !F.NAV.mimeTypes[t] || F.NAV.mimeTypes[t].enabledPlugin)
              )
                for (
                  var s = 0, l = (i = r.replace(e, "").replace(/^\s+/, "").replace(/\sr/gi, ".").split(".")).length;
                  s < l;
                  s++
                )
                    ...
                    (d["get" + e] = function () {
                      ...
                      (d["set" + e] = function (e) {
                        if (-1 === b.default.html5media.readOnlyProperties.indexOf(r))
                          if ("src" === r) {
                            if (
                              ((d[r] = "object" === (void 0 === e ? "undefined" : y(e)) && e.src ? e.src : e),
                              null !== u)
                            ) {
                              var t = { type: "flv" };
                    ...
                    (f["get" + e] = function () {
                      ...
                      (f["set" + e] = function (e) {
                        if (-1 === b.default.html5media.readOnlyProperties.indexOf(o))
                          if ("src" === o) {
                            if (
                              ((f[o] = "object" === (void 0 === e ? "undefined" : y(e)) && e.src ? e.src : e),
                              null !== c)
                            ) {
                              c.destroy();
                ...
                x = {
                  ...
                  events: {
                    onReady: function (e) {
                      ...
                      for (
                        var u = ["rendererready", "loadedmetadata", "loadeddata", "canplay"], c = 0, f = u.length;
                        c < f;
                        c++
                      ) {
